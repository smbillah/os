...
#define UNIONFS_SUPER_MAGIC WRAPFS_SUPER_MAGIC

/* the file system name */
//#define UNIONFS_NAME "unionfs"
#define UNIONFS_NAME "u2fs"
 ...
 */
static inline void release_open_intent(struct nameidata *nd)
{
...
static inline struct dentry *lookup_one_len_nd(const char *name, struct dentry *base,
